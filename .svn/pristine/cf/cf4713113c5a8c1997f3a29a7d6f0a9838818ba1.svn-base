...
//    }
    ...
    public static List<Object[]> cccClient2Service(String Method, List<String> objects) {
        if (dcf1==null||client1==null){
            dcf1= JaxWsDynamicClientFactory.newInstance();//10.241.121.221
//            client1 = dcf1.createClient("http://10.241.121.221/CDataCenter/CDataCenter.asmx?wsdl");
...
//            client2 = dcf2.createClient("http://10.241.121.221/CDataCenter/CDataCenter.asmx?wsdl");
//            client2 = dcf2.createClient("http://192.168.10.1/CDataCenter/CDataCenter.asmx?WSDL");
        }
        Object[] objects1;
        // invoke("方法名",参数1,参数2,参数3....);
        try {
